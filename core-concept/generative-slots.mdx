...
Many more examples of generative slots are provide in the `docs/examples` directory.
...
To help us compose these libraries, we introduce a set of contracts that gate function composition and then use those contracts short-circuit non-sensical compositions of library components:
