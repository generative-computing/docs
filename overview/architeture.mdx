...
<img src="/images/architecture/IMG_9804.jpg" />
...
This is not an exhaustive list of possible component types. New components can be created as user libraries or as stdlib contributions. Where it makes sense, you can also back new components by [fine-tuned models designed especially to work with your Component types](/core-concept/adapters).
