---
title: react_instruct
---

This is the code for `react_instruct.py`:
<CodeGroup>
...
class ReactTool(pydantic.BaseModel):
    ...
    def args_schema(self):
        ...
        for param_name, param in sig.parameters.items():
            fields[param_name] = str  # TODO use typing.get_type_hints
...
def react(
    ...
    # TODO should we make ReACT a component so that different models can specify the system prompt differently?
    ...
    while not done:
        ...
        )  # TODO most models have a way of doing this.
        print(tool_output)
