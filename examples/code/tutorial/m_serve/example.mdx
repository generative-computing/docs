...
# TODO: Might want to move this to the stdlib?
...
# TODO: Should we move this into the app.py? This would give us control on using other fields from the ChatCompletionRequest
